...
export default function HeaderTop() {
  return (
    <div className="w-full bg-[#f4e1b6] text-[#2c2c2c] text-xs sm:text-sm shadow-sm border-b border-[#e0c97d]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2 sm:py-3 flex flex-col md:flex-row items-center justify-between gap-2 sm:gap-6">
